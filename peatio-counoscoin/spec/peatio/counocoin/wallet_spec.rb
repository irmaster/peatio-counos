RSpec.describe Peatio::Counoscoin::Wallet do
  let(:wallet) { Peatio::Counoscoin::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::Counoscoin::Wallet.new }
    ...
    it 'sets settings attribute' do
      ...
      expect(unconfigured_wallet.settings).to eq(settings.slice(*Peatio::Counoscoin::Wallet::SUPPORTED_SETTINGS))
    end
  end
